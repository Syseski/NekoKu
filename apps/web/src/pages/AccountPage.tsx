...
export const AccountPage: React.FC = () => {
  ...
  if (!user) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center px-4 text-center">
        ...
        <h2 className="text-2xl font-black text-slate-900 mb-2">{t.signInToViewAccount}</h2>
  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setProfileSuccessMsg(t.profileUpdated);
  ...
  const handleDeleteAddress = async (id: string) => {
    const confirmMsg = language === 'ms' ? 'Adakah anda pasti mahu memadam alamat ini?' : 'Are you sure you want to delete this delivery address?';
          ...
          <div className="text-center sm:text-left flex-1">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 text-xs text-white/90">
              <span className="bg-black/15 px-3 py-1 rounded-full backdrop-blur-xs">
                🐱 {t.catsRegistered.replace('{count}', String(user.catProfiles?.length || 0))}
              </span>
              <span className="bg-black/15 px-3 py-1 rounded-full backdrop-blur-xs">
                📍 {t.savedAddresses.replace('{count}', String(addresses.length))}
              </span>
            </div>
          </div>
        </div>
          ...
          {activeTab === 'profile' && (
            <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-xs">
              <div className="border-b border-slate-100 pb-4 mb-6">
                <h2 className="text-xl font-extrabold text-slate-900">{t.personalInfo}</h2>
              ...
              <form onSubmit={handleSaveProfile} className="space-y-6">
                ...
                <div>
                  ...
                  />
                  <p className="text-[11px] text-slate-400 mt-1">{t.emailCannotChange}</p>
                </div>
                ...
                <div className="pt-4 border-t border-slate-100 flex justify-end">
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-sm font-bold shadow-md shadow-amber-600/20 hover:scale-[1.02] active:scale-95 transition-all duration-200 disabled:opacity-50"
                  >
          ...
          {activeTab === 'addresses' && (
            <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-xs">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
                <div>
                  <h2 className="text-xl font-extrabold text-slate-900">{t.myAddressesTitle}</h2>
                  <p className="text-slate-500 text-sm">{t.myAddressesDesc}</p>
                </div>
                <button
                  onClick={handleOpenAddAddress}
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold shadow-md shadow-amber-600/20 hover:scale-105 active:scale-95 transition-all duration-200"
                >
              ...
              {isLoadingAddresses ? (
                ...
                <div className="py-12 text-center">
                  ...
                  <h3 className="text-base font-bold text-slate-800">{t.noAddressesYet}</h3>
                  <p className="text-slate-500 text-xs mt-1 mb-4">{t.noAddressesDesc}</p>
                  <button
                    onClick={handleOpenAddAddress}
                    className="px-5 py-2 rounded-full bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold shadow-md shadow-amber-600/20"
                  >
                    {t.addAddressNow}
                  </button>
                </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2 self-end sm:self-start pt-2 sm:pt-0">
                          <button
                            ...
                            className="p-2 rounded-lg text-slate-600 hover:text-amber-700 hover:bg-amber-50 transition-colors text-xs font-semibold flex items-center gap-1"
                          >
                          ...
                          {!addr.isDefault && (
                            <>
                              <button
                                ...
                                className="p-2 rounded-lg text-slate-600 hover:text-amber-700 hover:bg-amber-50 transition-colors text-xs font-semibold"
                              >
                                {t.setDefaultBtn}
                              </button>
                              <button
            ...
            <form onSubmit={handleSaveAddress} className="space-y-4">
              ...
              <div className="pt-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-xs text-slate-700 font-medium">{t.setAsDefault}</span>
                </label>
              </div>
              ...
              <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold shadow-md shadow-amber-600/20 transition-all disabled:opacity-50"
                >
                  {isSavingAddress ? t.saving : editingAddress ? t.updateAddress : t.saveAddress}
                </button>
              </div>
            </form>
          </div>
