...
import { ShoppingBag, ShieldCheck, Heart, User, LogOut, Package, Sparkles } from 'lucide-react';
              ...
              <>
                <Link
                  ...
                  className={`relative py-1 flex items-center gap-1.5 transition-colors duration-200 ${
                    location.pathname === '/cats' ? 'text-brand-600 font-bold' : 'text-slate-600 hover:text-slate-900'
                  }`}
                >
                  <Heart className="w-4 h-4 text-brand-500 animate-pulse-gentle" />
                  My Cat Profiles
                ...
                <Link
                  to="/orders"
                  className={`relative py-1 flex items-center gap-1.5 transition-colors duration-200 ${
                    location.pathname === '/orders' ? 'text-brand-600 font-bold' : 'text-slate-600 hover:text-slate-900'
                  }`}
                >
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              <div className="relative">
                ...
                {userDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 rounded-2xl bg-white/95 backdrop-blur-md shadow-2xl border border-slate-100 p-2 z-50 animate-scale-in">
