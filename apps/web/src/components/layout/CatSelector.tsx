    ...
    <>
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-orange-50 border border-orange-200 hover:border-brand-400 text-slate-800 transition shadow-sm text-sm font-medium"
        >
          {activeCat ? (
            <>
              <div className="w-6 h-6 rounded-full overflow-hidden bg-brand-200 flex-shrink-0 flex items-center justify-center text-xs font-bold text-brand-800">
                {activeCat.avatarUrl ? (
              ...
              <span className="truncate max-w-[120px] text-slate-900 font-semibold">
                {activeCat.name}
              </span>
              <span className="text-[11px] px-1.5 py-0.5 rounded bg-orange-200/70 text-orange-900 font-medium hidden sm:inline-block">
            ...
            <>
              ...
              <span className="text-slate-700">Select Cat Profile</span>
            </>
          )}
