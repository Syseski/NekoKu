...
async function main() {
    ...
    const adminPasswordHash = await bcryptjs_1.default.hash('admin12345', 10);
    ...
    const mochi = await prisma.catProfile.create({
        data: {
            ...
            lifeStage: client_1.LifeStage.ADULT,
            weightKg: 4.8,
            isNeutered: true,
            ...
            healthConcerns: {
                create: [
                    { condition: client_1.HealthFocusType.URINARY_CARE },
                    { condition: client_1.HealthFocusType.HAIRBALL_CONTROL },
                ],
            },
        },
    });
    const luna = await prisma.catProfile.create({
        data: {
            ...
            name: 'Luna',
            breed: 'Scottish Fold',
            lifeStage: client_1.LifeStage.KITTEN,
            weightKg: 1.9,
            isNeutered: false,
            ...
            healthConcerns: {
                create: [
                    { condition: client_1.HealthFocusType.SENSITIVE_DIGESTION },
                    { condition: client_1.HealthFocusType.SKIN_AND_COAT },
                ],
            },
        },
    });
    const oliver = await prisma.catProfile.create({
        data: {
            ...
            lifeStage: client_1.LifeStage.SENIOR,
            weightKg: 6.2,
            isNeutered: true,
            ...
            healthConcerns: {
                create: [
                    { condition: client_1.HealthFocusType.KIDNEY_SUPPORT },
                    { condition: client_1.HealthFocusType.WEIGHT_MANAGEMENT },
                ],
            },
        },
    });
    ...
    const productsData = [
        {
            ...
            price: 54.99,
            stockQuantity: 45,
            targetLifeStage: client_1.LifeStage.ADULT,
            isSpecialtyDiet: true,
            isFeatured: true,
            rating: 4.9,
            ratingCount: 128,
            imageUrl: 'https://images.unsplash.com/photo-1589924691995-400dc9ecc119?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.URINARY_CARE],
        },
        {
            ...
            price: 58.50,
            stockQuantity: 30,
            targetLifeStage: client_1.LifeStage.SENIOR,
            isSpecialtyDiet: true,
            isFeatured: true,
            rating: 4.8,
            ratingCount: 94,
            imageUrl: 'https://images.unsplash.com/photo-1548767797-d8c844163c4c?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.KIDNEY_SUPPORT, client_1.HealthFocusType.GENERAL_WELLNESS],
        },
        {
            ...
            price: 46.99,
            stockQuantity: 60,
            targetLifeStage: client_1.LifeStage.ALL_STAGES,
            isSpecialtyDiet: false,
            isFeatured: true,
            rating: 5.0,
            ratingCount: 210,
            imageUrl: 'https://images.unsplash.com/photo-1568640347023-a616a30bc3bd?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.SKIN_AND_COAT, client_1.HealthFocusType.GENERAL_WELLNESS, client_1.HealthFocusType.HAIRBALL_CONTROL],
        },
        {
            ...
            price: 32.99,
            stockQuantity: 50,
            targetLifeStage: client_1.LifeStage.KITTEN,
            isSpecialtyDiet: true,
            isFeatured: true,
            rating: 4.9,
            ratingCount: 88,
            imageUrl: 'https://images.unsplash.com/photo-1535930891776-0c2dfb7fda1a?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.SENSITIVE_DIGESTION, client_1.HealthFocusType.SKIN_AND_COAT],
        },
        {
            ...
            ratingCount: 142,
            imageUrl: 'https://images.unsplash.com/photo-1589924691995-400dc9ecc119?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.HAIRBALL_CONTROL, client_1.HealthFocusType.SENSITIVE_DIGESTION],
        },
        {
            ...
            ratingCount: 75,
            imageUrl: 'https://images.unsplash.com/photo-1548767797-d8c844163c4c?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.SKIN_AND_COAT, client_1.HealthFocusType.WEIGHT_MANAGEMENT],
        },
        {
            ...
            ratingCount: 340,
            imageUrl: 'https://images.unsplash.com/photo-1583337130417-3346a1be7dee?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.SKIN_AND_COAT, client_1.HealthFocusType.GENERAL_WELLNESS],
        },
        {
            ...
            ratingCount: 412,
            imageUrl: 'https://images.unsplash.com/photo-1615789591457-74a63395c990?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.GENERAL_WELLNESS],
        },
        {
        ...
        },
        {
            ...
            ratingCount: 95,
            imageUrl: 'https://images.unsplash.com/photo-1548767797-d8c844163c4c?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.HAIRBALL_CONTROL, client_1.HealthFocusType.WEIGHT_MANAGEMENT],
        },
        {
            ...
            ratingCount: 156,
            imageUrl: 'https://images.unsplash.com/photo-1568640347023-a616a30bc3bd?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.SENSITIVE_DIGESTION, client_1.HealthFocusType.GENERAL_WELLNESS],
        },
        {
            ...
            ratingCount: 180,
            imageUrl: 'https://images.unsplash.com/photo-1583337130417-3346a1be7dee?auto=format&fit=crop&w=600&q=80',
            healthFocuses: [client_1.HealthFocusType.DENTAL_CARE],
        },
    ];
